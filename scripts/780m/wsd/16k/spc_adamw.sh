...
torchrun --nproc_per_node=4 your_path/src/main.py \
    ...
    --opt adamw --lr 1e-3 --weight_decay 0.1 --scheduler wsd --decay_type sqrt --wsd_fract_decay 0.2 \
    --spectral_post_process clip --spectral_clip_c 10.0 --clip_decay_type sqrt  \
